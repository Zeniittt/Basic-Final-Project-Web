                            ...
                            <div class="col-lg-12 text-right">
                                ...
                                <nav class="navbar">
                                    ...
                                    <ul class="navbar_user">
                                        ...
                                        <li class="checkout">
                                            <a href="<c:url value='/cart/showCart'/>">
                        ...
                        <div class="sidebar">
                            <div class="sidebar_section">
                                ...
                                <ul class="sidebar_categories">
                                    <li><a href="DetailBook.jsp">Men</a></li>
                                                ...
                                                <div class="product-item men">
                                                    <div class="product discount product_filter">
                                                        <div class="product_image">
                                                            <img src="<c:url value='/${i.image}' />" alt="">
                                                        </div>
                                                        <div class="favorite favorite_left"></div>    
                                                        <div class="product_info">
                                                            <h6 class="product_name"><a href="<c:url value='/detail/detailBook'/>?idBook=${i.id}">${i.name}</a></h6>
                                                            <div class="product_price">${i.price}</div>
                                                        </div>
                                                    </div>
                                                            <div class="red_button add_to_cart_button"><a href="<c:url value='/cart/addItem'/>?idBook=${i.id}">add to cart</a></div>
                                                </div>
                                            </c:forEach>  
