...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="<c:url value="/styles/cart.css"/>">
    </head>
    ...
    <body>
                            ...
                            <div class="col-lg-12 text-right">
                                ...
                                <nav class="navbar">
                                    <ul class="navbar_menu">
                                        ...
                                        <li><a href="<c:url value='/shop/showAllBook'/>">shop</a></li>
                                        ...
                                        <div class="col-md-8 cart">
                                            <div class="title">
                                                <div class="row">
                                                    ...
                                                    <div class="col align-self-center text-right text-muted">${cart.getCount()}</div>
                                                </div>
                                            </div>   
                                            <c:forEach items="${cart.items}" var="i">
                                                <div class="row border-top border-bottom">
                                                    <div class="row main align-items-center">
                                                        <div class="col-2"><img class="img-fluid" src="<c:url value='/${i.book.image}' />"></div>
                                                        <div class="col">
                                                            <div class="row text-muted">${i.book.price}</div>
                                                            <div class="row">${i.book.name}</div>
                                                        </div>
                                                        <div class="col">
                                                            <a href="<c:url value='/cart/decreaseQuantity'/>?idBook=${i.book.id}&amp;quantity=${i.quantity}">-</a><a href="#" class="border">${i.quantity}</a><a href="<c:url value='/cart/increaseQuantity'/>?idBook=${i.book.id}&amp;quantity=${i.quantity}">+</a>
                                                        </div>
                                                        <div class="col">${i.getTotal()}<span class="close"><a href="<c:url value='/cart/removeItem'/>?idBook=${i.book.id}&amp;quantity=${i.quantity}">&#10005;</a></span></div>
                                                    </div>
                                                </div>
                                            </c:forEach>  

                                                    <div class="back-to-shop"><a href="<c:url value='/shop/showAllBook'/>">&leftarrow;</a><span class="text-muted"><a href="<c:url value='/shop/showAllBook'/>">Back to shop</a></span></div>
                                        </div>
                                        <div class="col-md-4 summary">
                                            <div><h5><b>Summary</b></h5></div>
                                            <hr>
                                            <div class="row">
                                                <div class="col" style="padding-left:0;">ITEMS ${cart.getCount()}</div>
        ...
        <script src="<c:url value='/jplugins/OwlCarousel2-2.2.1/owl.carousel.js'/>"></script>
        ...
        <script src="<c:url value='/styles/cart.css'/>"></script>
    </body>
